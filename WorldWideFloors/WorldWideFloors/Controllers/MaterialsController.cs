...
namespace WorldWideFloors.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Price,AmountLeft")] Materials materials)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Price,AmountLeft")] Materials materials)
        {
            if (ModelState.IsValid)
            {
